            ...
            <nav class="navbar navbar-toggleable-md navbar-light bg-faded fixed-top navbar-inverse">
                <div class="container">
                    ...
                    <div class="col-sm-3">
                        ...
                        <ul>
                            <li><a class="active" href="<?php echo base_url(); ?>welcome/index.html">হোম</a></li>
                            <li><a href="<?php echo base_url(); ?>welcome/calan.html">ডেলিভারি চালান</a></li>
                            ...
                            <li style="float:right"><a href="<?php echo base_url(); ?>welcome/customer.html">কাস্টমার তথ্য</a></li>
                        </ul>
        ...
        <div id="content-wrap">
            ...
            <div class="jumbotron" id="#hero" data-stellar-background-ratio="0.5" data-stellar-vertical-offset="0">
                ...
                <div class="container">
                    ...
                    <h3>ডিলার : বি.এস.এম এন্ড আনোয়ার সিমেন্ট</h3>
                    <h3>ব্রাহ্মানবাড়িয়া  অফিস</br>
                        এ.খালেক কমপ্লেক্স</br>
                    ...
                    <div class="container">
                        ...
                        <div id="page-wrap">
                            ...
                            <div id="toper">
                                ...
                                <h5 >&emsp;&emsp;&emsp;&emsp;ক্যাশ মেমো</h5>
                                <h3>মেসার্স হাজী আবুল কাশেম এন্ড সন্স</h3>

                                <h5>&emsp;&emsp;&emsp;&emsp;&emsp;প্রোঃ জিয়াউল হক</h5>
    ...
    <div class="clearfix">
      ...
      <button type="submit" class="signupbtn">Sign Up</button>
                            ...
                            <div id="block_container">
                                ...
                                <div id="bloc1" > <u>ক্রেতার স্বাক্ষর </u></div>  
